    ...
    render(){
      const scrollEnabled = this.state.screenHeight > height;
        return(
          ...
          >
          <View style={{flex:1, flexDirection:'column', alignItems:'center', marginTop:15, paddingBottom:15, width:'100%'}}>
