...
class CalculatorScreen extends React.Component {
  ...
  render() {
    ...
    <StatusBar
        ...
        backgroundColor="#085078"
        />
        <View style={{flex: 0.35, Height: '100%', padding: 0, backgroundColor:'white', alignContent: 'center', alignItems: 'center', flexDirection: 'column', elevation: 1}}>
      ...
      onPress={()=>{
        ...
        >
         <Text style={{fontSize: 20, color: 'white'}}>Calculate GPA </Text>
        </TouchableHighlight>
      </View>
      </View>
      <TouchableOpacity style={{flex: 1, flexDirection:'row', paddingRight:20, paddingLeft:10, alignSelf:'flex-end'}}>
      <Text style={{fontSize:18, color:"#085078", marginHorizontal:10}}>Grade Scale</Text><Icon name="arrow-down" size={15} style={{color:'#085078', marginTop: 5}}/>
      </TouchableOpacity>
        </View>
        <View style={{flex: 0.15, width:'100%', flexDirection:'row', alignContent: 'center', alignItems: 'center', marginVertical: 5, backgroundColor:'white', elevation: 1}}>
        <View style={{width:'80%'}}>
        ...
        <Text style={{color:'#085078', marginTop: 5, marginRight:10, fontSize:22, fontWeight:'bold'}}>3.80</Text>
        </View>
        </View>
        <View style={{flex:0.50, alignSelf: 'stretch', height: 50, marginTop:2, backgroundColor:'white', alignContent: 'center', alignItems: 'center', flexDirection: 'column', elevation: 2}}>
        {this.props.schools ?
        <FlatList
